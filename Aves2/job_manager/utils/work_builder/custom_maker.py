...
PADDLE_WORKER_DEFAULT_PORT = 2222


class K8sCustomTrainMaker(BaseMaker):
    def __init__(self, **kwargs):
        super(K8sCustomTrainMaker, self).__init__(**kwargs)
    ...
    def gen_worker_ports(self):
        ports = self.target_worker.ports if self.target_worker.ports else [PADDLE_WORKER_DEFAULT_PORT]
        return ports
